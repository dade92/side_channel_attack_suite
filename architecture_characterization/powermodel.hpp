 ...
 * model and the array of the plaintext
 */

class PowerModel {
public:
    PowerModel(interval& it,Config& c);
    void generate(uint8_t** plaintext,unsigned**powerMatrix);
private:
    string powerModel,position;
